...
export const LanguageToggle: React.FC = () => {
  ...
  return (
    <button
      ...
      className="p-1.5 text-content-secondary hover:text-content-primary rounded-lg border border-border-subtle bg-surface-elevated hover:bg-surface cursor-pointer min-h-[48px] min-w-[48px] flex items-center justify-center gap-1 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-border-interactive focus:ring-offset-2 focus:ring-offset-surface font-semibold text-xs"
